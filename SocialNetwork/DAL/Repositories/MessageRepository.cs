...
namespace SocialNetwork.DAL.Repositories
{
    public class MessageRepository : BaseRepository, IMessageRepository
    {
        ...
        {
            return Execute(@"insert into messages(content, sender_id, recipient_id) value(:content,:sender_id,:recipient_id)", messageEntity);
        }
        ...
        {
            return Execute("delete from message where id = :id", new { id = messageId });
        }
    }
}
